...
window.addEventListener('DOMContentLoaded', () => {
  ...
  KEEP.printThemeInfo = () => {
    ...
    const img = `font-size: 1px;
    margin-left: 30px;
    padding: 100px 100px;
    background-image: url(https://itiandong.com/images/avatar.jpg);
    background-size: contain;
    background-repeat: no-repeat;
    color: transparent;`
    const empty = `font-size: 1px;
    padding: 0;
    background-image: '';
    background-size: contain;`
    const ns = '\u200b';
    // console.log("\n%c+", img);
    console.log(`\n%c${ns}%c\n %c Tilden's Notes %c https://itiandong.com \n`, img, empty, `color: #fadfa3; background: #333; padding: 5px 0;`, `background: #fadfa3; padding: 5px 0;`);
  }
